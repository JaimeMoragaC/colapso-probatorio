...
Este fue el desconcierto que ordenó mi tesis. No hay punto de apoyo inexpugnable. Cada medida que implementé cayó ante un adversario con el privilegio y el incentivo suficientes. Contra un adversario agéntico —el patrón post-Mythos, operando a velocidad de máquina y costo marginal cero— la detección perfecta es un mito. Pretender detenerlos con barreras lógicas es intentar contener el mar con una cuchara.
