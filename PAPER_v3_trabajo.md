...
Una asimetría fundamental recorre todo este trabajo y conviene fijarla desde aquí, pues reaparece en cada sección como su estribillo mandatorio: *el choque frontal entre el tiempo de la máquina y el tiempo humano*. 
...
La «Visión de Riesgo» del diagnóstico nacional de inteligencia de amenazas lo nombra sin rodeos: la superficie de ataque —infraestructuras descentralizadas en la nube (IaaS, PaaS, SaaS), microservicios, APIs expuestas y modelos de IA embebidos en procesos críticos— genera una complejidad donde el "principal problema es la falta de visibilidad integral sobre los activos"236.
...
El punto de inflexión evolutivo que Mythos aporta en 2026 —y que expone la insuficiencia del estándar probatorio que marcos como la Ley 21.663 presuponen— no es la invención de la exfiltración o de la propagación autónoma. Esas capacidades ya habían sido demostradas en la capa de aplicación por agentes como IPI, Morris II y campañas como JadePuffer.

El verdadero salto cualitativo es el control directo de la memoria y del núcleo del sistema operativo. Mythos ataca exactamente la frontera arquitectónica donde reside la raíz de la telemetría, el lugar exacto donde el sistema decide qué es verdad y qué es mentira.
...
Julio de 2023 (El origen en foros): Investigadores de SlashNext documentaron WormGPT —un modelo sin restricciones éticas, entrenado específicamente sobre datos de desarrollo de malware—22. Esta amenaza cruzó el  umbral teórico rápidamente: el CrowdStrike Global Threat Report confirmó que grupos cibercriminales operaron campañas de ransomware (variantes FunkLocker y RALord) con firmas atribuibles directamente a plantillas generadas por este modelo.

Julio de 2023 (La economía de plataforma): El equipo de Netenrich detectó FraudGPT, anunciado en Telegram como un servicio "sin límites éticos", acumulando más de 3.000 suscriptores con cuotas de USD 1.700 anuales23. Se inauguró el modelo de suscripción comercial (SaaS) para ataques asistidos por IA.

Marzo de 2024 (El salto a la propagación autónoma - Morris II): Investigadores de Cornell Tech y Technion publicaron el código de Morris II, el primer gusano de inteligencia artificial generativa (GenAI worm). El hito demostró que un agente ya no solo podía redactar código malicioso a pedido, sino que podía envenenar flujos de IA (RAG) para propagarse de un sistema a otro de forma autónoma a través de la capa de aplicación, exfiltrando datos sin intervención humana.

Enero de 2025 (La apertura del motor cognitivo): DeepSeek publicó DeepSeek-R1 con licencia MIT y pesos descargables desde Hugging Face24, entregando desempeño de razonamiento profundo (comparable a modelos propietarios de frontera) a cualquier actor equipado con una GPU de consumo. El monopolio corporativo de la inteligencia de amenazas se rompió.

Junio de 2025 (La supremacía autónoma): XBOW —plataforma de pentesting autónomo— alcanzó el primer lugar global del ranking de HackerOne, superando por primera vez a miles de investigadores humanos en la identificación, triaje y explotación de vulnerabilidades reales en entornos de producción25.
...
Este colapso empírico justifica de manera irrefutable nuestra tesis central: la obsolescencia procesal del modelo de compliance actual. Cuando el agente ofensivo purga la telemetría y los respaldos a velocidad de máquina, despoja instantáneamente al sujeto regulado —el Operador de Importancia Vital (OIV) o la entidad financiera— del único sustrato material que le permitiría estructurar su defensa. Al momento de emitir el reporte de incidente mandatado por la Ley 21.663 o la NCG 502 de la CMF, el Directorio y su Oficial de Seguridad quedan atrapados en una indefensión jurídica absoluta: la ley les impone una carga de la prueba estricta sobre una infraestructura que ha sido desprovista de su memoria forense. 

El caso de PUNK SPIDER demuestra en la práctica que extraer evidencia probatoria desde el mismo sistema operativo que sufre el ataque es un ejercicio fútil. Confirma, en definitiva, que la auditoría delegada es una ficción procesal insostenible, y que el cumplimiento normativo real solo puede existir si la evidencia se ancla en un sistema de atestación aislado, capaz de sobrevivir a la destrucción del entorno que audita.

### El fenómeno de la horda: industrialización criminal de las capacidades tipo Mythos

La descripción anterior cubre la progresión tecnológica. Lo que el análisis  de amenazas requiere además es comprender el fenómeno de escala: no se trata solo de la adopción pionera de la IA por parte de las Amenazas Persistentes Avanzadas (APT) patrocinadas por estados —clasificadas en la inteligencia forense global según su origen geopolítico como *Bears* (Rusia), *Pandas* (China), *Chollimas* (Corea del Norte) o *Kittens* (Irán)—.

El verdadero colapso asimétrico proviene de la masa de cibercriminales de motivación financiera (*Spiders* en la taxonomía) que, sin los recursos ni la sofisticación tradicional de un actor estatal, acceden hoy a capacidades ofensivas de grado militar a través de una cadena de suministro impulsada por modelos abiertos que ya opera como industria estructurada.
...
La doctrina técnica tradicional sostiene que la amenaza del agente autónomo se neutraliza mediante sistemas defensivos automatizados (XDR/EDR) que operan a la misma velocidad de máquina, amparados en las restricciones deterministas del procesador (SMEP/SMAP/ASLR). Este argumento adolece de ceguera topológica.

Un agente ofensivo avanzado (como Mythos) no desafía la física del hardware; la instrumentaliza. Al ensamblar dinámicamente cadenas de ejecución sobre el propio código legítimo del sistema (Return-Oriented Programming), el ataque es validado por el procesador como una instrucción nativa. Más grave aún: dado que el agente corrompe el estrato base de la memoria, subyaga el entorno del cual la IA defensiva (el EDR) extrae su telemetría. La defensa algorítmica corporativa no falla por lentitud, falla por epistemología: procesa a la perfección una realidad que el atacante ya ha falsificado. Confiar el cumplimiento normativo a un EDR que reside en el mismo espacio comprometido es, en la arquitectura post-Mythos, una negligencia estructural insalvable.

 Esto dejó de ser una inferencia arquitectónica para volverse operación documentada: en 2026, el cártel de *ransomware* «The Gentlemen» mantiene un marco propio de neutralización de defensas (*GentleKiller*) que apunta a más de 400 procesos de 48 fabricantes de seguridad —Microsoft Defender, CrowdStrike Falcon, SentinelOne, Sophos, Kaspersky, Bitdefender— mediante la técnica *Bring Your Own Vulnerable Driver* (BYOVD): carga un controlador firmado pero vulnerable para operar en el anillo del *kernel*, por debajo de la capa donde el EDR ejecuta, y desde ahí lo apaga. 
 
 Cuando el agente de *endpoint* es deshabilitado —como ocurre cada vez con mayor frecuencia en 2026—, la propia industria reconoce que solo la telemetría de red, externa al *host*, permanece inmanipulable; la evidencia local que la Ley 21.663 presupone ya no existe. La formalización taxonómica acompaña al hecho: la versión 19 de MITRE ATT&CK (2026) reestructuró la evasión de defensas e introdujo la técnica T1687 —*Exploitation for Defense Impairment*—, que cataloga exactamente esta conducta de explotar una vulnerabilidad para inutilizar el control de seguridad<a href="#fn266" id="fnref266"><sup>266</sup></a>.

 La ceguera institucional frente a este salto asimétrico quedó documentada oficialmente en el Boletín de Amenazas del CSIRT Nacional (Q1 2026). Mientras la telemetría global registra el colapso del tiempo de desplazamiento lateral a fracciones de minuto y asedios agénticos en memoria, el Estado chileno proyecta los avances en IA generativa como una herramienta futura para la "detección de vulnerabilidades", aconsejando tomar las noticias "con cautela". 
 
 Peor aún, frente a actores como GRAM-5A que exfiltran datos de infraestructura crítica, el organismo receta como mitigación el uso de antivirus tradicionales, filtros web (WAF) y la implementación de MFA. Recetar barreras lógicas de Capa 7 y análisis de firmas estáticas contra un adversario que parchea la memoria en Ring-0, desactiva el EDR silenciosamente o secuestra el token de sesión post-MFA, constituye una negligencia arquitectónica severa. El boletín oficial es la demostración palmaria de que el regulador nacional sigue fiscalizando y defendiendo bajo el modelo de amenazas del 2019
...
A este argumento estructural debe sumarse una corrección forense mandatorio respecto a las cifras citadas: el sesgo de supervivencia de la telemetría ciega. 
...
Peor aún, debido al bloqueo analítico impuesto sobre Mythos, se consagra una asimetría defensiva crítico: mientras los atacantes utilizan IA de frontera sin restricciones legales, los CISOs en Chile quedan jurídicamente bloqueados de utilizar esas mismas capacidades comerciales para auditar sus infraestructuras, siendo empujados a una inferioridad táctica inaceptable.
...
#### Solución:
El Pilar 2 requiere un artículo específico de continuidad soberana que traduzca los principios del derecho comparado recién expuesto —la determinación del tiempo de resiliencia (KRITIS), la topología descentralizada (X-Road) y el mandato mandatorio de continuidad (NIS2)— a la realidad de la Inteligencia Artificial. Esto exige abandonar el concepto obsoleto de *frontera horizontal* (geográfica) y adoptar la frontera vertical de la Soberanía Forense (ver Objeción D, §6.7): la soberanía no se pierde porque el cómputo ocurra físicamente en Virginia, se pierde porque el Estado chileno carece de una raíz de confianza en el *hardware* que le permita auditar esa ejecución. 
...
El §6.3.3 provee la arquitectura de este artículo.
...
Ninguna jurisdicción ha completado la solución definitiva; sin embargo, todos señalan hacia el mismo requisito mandatorio: evidencia atestada del estado del sistema en el momento exacto del evento.
...
- Reino Unido y Estados Unidos (NCSC / CISA): En sus *Guidelines for Secure AI System Development* (2023), exigen establecer un *baseline* de comportamiento ("*known good*") en la fase de diseño, como requisito mandatorio para detectar ataques adversariales de acumulación gradual y *model drift* durante la operación continua<a href="#fn94" id="fnref94"><sup>94</sup></a>.
...
### La anatomía de la brecha: Seis vectores hacia la asimetría perfecta
...
- [La Trampa Final] Qué resuelve el anclaje físico, y qué no
  ...
  - El horizonte mandatorio: La exigencia probatoria debe escalar, por ello, hacia la atestación continua en tiempo de ejecución (*continuous runtime attestation*). Esta constituye un horizonte de diseño hacia el cual transita la industria —con implementaciones parciales actuales como Intel CET, ARM MTE o las arquitecturas CHERI—, pero aún no existe como solución madura llave en mano. El objetivo final es que la raíz de confianza en el silicio valide no solo el inicio, sino la integridad del flujo de ejecución y del estado de la memoria en tiempo real.
...
Para dimensionar esta asimetría, analicemos la estructura real de costos en la exfiltración de 250 GB de fichas médicas de una clínica privada por parte del grupo "Devman". Lejos de la ilusión de un ataque costoso, el desglose tecno-económico ejecutado mediante IA agéntica opera bajo un costo marginal que tiende asintóticamente a cero:
...
2. **Cómputo y Cognición Agéntica (Parasitismo de CPU/RAM):** El cartel no alquila costosos clústeres de GPUs en jurisdicciones *bulletproof*. Una vez superado el perímetro, inyecta un modelo de lenguaje cuántico y liviano (*Small Language Model* cuantizado a 4 bits) directamente en la memoria RAM del hipervisor (VMware ESXi) de la clínica. El adversario utiliza los procesadores y la energía eléctrica del propio hospital para que la IA deduzca movimientos laterales y compile código polimórfico evasivo. 
   - **Costo de cómputo ofensivo:** **$0 USD** (subsidiado por la factura eléctrica de la víctima).
3. **Compresión Polimórfica y Evasión Criptográfica (El robo del ancho de banda):** Extraer 250 GB requiere ancho de banda. La IA secuestra los ciclos ociosos de la GPU de la clínica para comprimir los datos a 15 GB hiperdensos. Luego, compromete los *tokens* OAuth del administrador *Cloud* de la víctima y ordena al servidor enviar esos 15 GB directamente al *bucket* legítimo de AWS o Azure del propio hospital. El *Firewall* corporativo lo aprueba ciegamente como "tráfico de respaldo autorizado". El atacante luego descarga los datos desde la nube vulnerada a través de Tor.
...
5. **La Variante TOCTOU y la Persistencia Latente (El colapso de la Integridad a largo plazo):** Si el objetivo del adversario no es el secuestro financiero inmediato, sino el sabotaje absoluto, la exfiltración se vuelve innecesaria. El ataque no ocurre en un solo evento aislado. La IA agéntica viola el perímetro y se instala de forma permanente, hibernando en el *firmware* (UEFI/BIOS) para sobrevivir a los reinicios del sistema operativo sin tocar el disco duro. Durante meses o años, ejecuta ataques de adulteración *Time-of-Check to Time-of-Use* (TOCTOU) de manera asincrónica e intermitente. Esta operación requiere una sofisticación extrema: la IA realiza ingeniería inversa en tiempo real de las estructuras de memoria compartida para entender el esquema de la base de datos de la clínica. Cuando un médico ingresa una receta, el sistema *revisa* (Check) que la dosis es segura. En los milisegundos antes de que el sistema *escriba* (Use) esa información, el código polimórfico en el *kernel* inyecta un *hook* en el canal IPC y multiplica la dosis de quimioterapia por diez. El registro de auditoría de *software* (EDR/SIEM), también subyugado, indicará que el médico ordenó legítimamente la dosis crítico. Mantener esta presencia parasitaria a lo largo del tiempo tiene un costo operativo marginal de **$0 USD**, ya que la IA vive indefinidamente de la electricidad y la CPU de la víctima.
...
La consecuencia probatoria es la de todo este capítulo, ahora en su forma más pura: el esquema binario no puede probar el cumplimiento *ni* el incumplimiento. El responsable no puede acreditar que su agente *no* infirió —la derivación no deja traza en el control de acceso—; la víctima no puede acreditar que *sí* lo hizo —su expediente exhibe solo accesos lícitos—; y las tres preguntas del Cuadro 3.B se responden, otra vez, con silencio. La mi nimización sin observabilidad semántica atestada del tratamiento (§4.2; §6.3) es un deber sin instrumento de medida.
...
La Ley 21.663 impone a los Operadores de Importancia Vital (OIV) el deber mandatorio de garantizar la continuidad operacional de los servicios esenciales. Pero sería un error leer ese deber como una particularidad del régimen de ciberseguridad: es un deber transversal de todo el sistema regulado. 
...
*La densidad de este caso lo convierte en el exper imento controlado que la doctrina de evidencia digital rara vez tiene. Por eso merece más que una cita: su anatomía completa es el argumento.*
...
> 🔗 *[Para el desglose técnico de ingeniería sobre cómo el sistema Horizon fue diseñado para falsificar transacciones sin rastro criptográfico, véase el Anexo 4: La Asimetría Epistémica de la Caja Negra](#anexo-horizon)*
...
<a id="retorno-anexo5"></a>
> 🔍 *[Para el análisis técnico de ingeniería (exposición de memoria, ataques DMA y el colapso físico del BYOK y el "Zero Data Retention") que demuestra pericialmente la totalidad de esta exposición sistémica, consulte el Anexo 5: Anatomía Forense de la Hemorragia en VRAM](#anexo-hemorragia-vram).*
...
El fracaso material del cifrado en reposo como garantía de continuidad operacional y resguardo probatorio no es una contingencia; es una condición mandatorio del ecosistema *cloud*. Para compensar esta cesión absoluta del control sobre la memoria viva y la abdicación de la jurisdicción física, los proveedores han construido un denso andamiaje de mitigaciones contractuales (SLA), geográficas (Regiones Locales) y de *hardware* perimetral (Módulos HSM). Todas ellas han sido exquisitamente diseñadas con un solo fin: proyectar la apariencia de un aislamiento criptográfico invulnerable frente a los ojos inexpertos de un auditor.
...
Primera: la doble ventanilla no es redundancia supervisora; es ceguera correlacionada. El cuadrante (a) parece el más protegido del sistema —dos reguladores, dos plazos, dos formatos—. Pero ambos reportes se alimentan del mismo registro autodeclarado, generado por la misma infraestructura del mismo proveedor. En los términos del análisis bizantino de §7.2: dos observadores que interrogan al mismo testigo comprometido no suman tolerancia a fallos; replican el mismo error con membrete distinto. La supervisión dual multiplica el costo administrativo del obligado sin añadir un bit de verificabilidad — y multiplica también su exposición sancionatoria, porque el mismo *log* insuficiente puede fundar cargos paralelos ante dos autoridades (§3.8.1).
...
La RAN 20-7 y el derecho de auditoría probatoriamente vacío. La normativa de externalización vigente ya obliga a las entidades a mantener derechos de auditoría y de acceso sobre los servicios tercerizados —incluida la nube—. Pero ese derecho se satisface hoy entregando al auditor el informe SOC 2 del proveedor y el acceso a la misma telemetría autodeclarada que este documento ha examinado: es la versión contractual del *checkbox* que §4.5 denuncia — un derecho de auditoría que no puede producir más verdad que la que el auditado decide mostrar. La corrección no exige ley nueva: exige que el estándar de suficiencia del derecho de auditoría incorpore la atestación (§6.9). Y la ventana para hacerlo está literalmente abierta: el 7 de abril de 2026 la CMF puso en consulta pública la actualización integral del Capítulo 20-7, junto con el nuevo archivo normativo I28 sobre servicios externalizados, con vigencia proyectada al 1 de enero de 2027<a href="#fn224" id="fnref224b"><sup>224</sup></a>. El "shock asimétrico" que §7.1 postula en abstracto tiene, así, fecha, expediente y plazo de comentarios: la matriz de pagos del equilibrio de la opacidad puede alterarse con un párrafo en esa norma.
...
### 4.8 La imposibilidad probatoria bidireccional y La neutralización de la potestad sancionadora
...
![Figura 2: Árbol de decisión de responsabilidad penal corporativa basado en la arquitectura de atestación probatoria.](figura_ley.png "Flujo Ley 21.595")
...
## Profundizaciones en la frontera entre la prueba y la máquina
